...
class WordSourceEnum:
    """
    Enumeration of sources that words are defined from
    """
    Unknown = 0
    # Auto generated programatically from dictionary form
    AutoGenerated = 1
    # Defined in custom word definition file
    Custom = 2
...
class Word:
    ...
    def __init__(self, source_type=WordSourceEnum.Unknown):
        ...
        self.__forms = []
        self.__source = source_type

    def get_source(self) -> WordSourceEnum:
    ...
    def set_source(self, source: WordSourceEnum):
